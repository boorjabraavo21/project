...
export interface ApiExtendUserExtendUser extends Schema.CollectionType {
  collectionName: 'extend_users';
  info: {
    singularName: 'extend-user';
    pluralName: 'extend-users';
    displayName: 'ExtendUser';
    description: '';
  };
  options: {
